extends "res://Overworld/Sets/Cutscenes/Cutscene.gd"
...
func _ready():
	nextSet = "res://Overworld/Sets/Maps/Set1/CourtyardS1.tscn"
	...
	startPosition = Vector2(-1024, 832)
	
	setUp()

func _process(_delta):
	if $Camera2D.position.x >= 2048:
